...
export default function MapsetCard({ mapset, onUnlock }: MapsetCardProps) {
  ...
  return (
    <div
      ...
      className={`bg-gray-800/75 hover:bg-gray-800/90 backdrop-blur-md border rounded-lg p-4 cursor-pointer transition-colors flex items-center justify-between gap-4 h-24 ${
